          ...
          <div className={`relative overflow-hidden rounded-3xl border px-6 py-14 backdrop-blur-xl sm:px-8 sm:py-16 md:px-16 md:py-20 ${
            ...
            <div className="relative">
              ...
              <motion.div
                ...
                className={`mb-7 inline-flex items-center gap-2 rounded-full border px-5 py-1.5 ${
                  isDark ? "border-violet-500/20 bg-violet-500/10" : "border-violet-200 bg-violet-100"
                }`}
              >
              ...
              >
                Generate code, refactor existing files, explain complex logic, and build complete CRUD APIs —
              ...
              >
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
                  <button
                    ...
                    className="group inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-violet-600 to-fuchsia-600 px-8 py-4 text-base font-semibold text-white shadow-lg shadow-violet-500/25 transition-all hover:shadow-xl hover:shadow-violet-500/40 cursor-pointer"
                  >
                    Get Started Free
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.97 }}>
                  <button
                    ...
                    className={`inline-flex items-center gap-2 rounded-full border px-8 py-4 text-base font-semibold transition-colors cursor-pointer ${
