  ...
  const runReview = async () => {
    ...
    try {
      const response = await askRepository({
        question: `Review this file for bugs, security issues, performance problems, and best practices: ${selectedFile}`,
      ...
      <div className="space-y-6">
        ...
        <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className={`mt-1 text-sm ${isDark ? "text-slate-400" : "text-slate-500"}`}>
            Select a file and get an AI-powered code review with severity ratings and fix suggestions
          </p>
        </motion.div>
