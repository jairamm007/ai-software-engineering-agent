  ...
  return (
    <DashboardLayout>
      <div className="space-y-8">
        ...
        <div className={`flex flex-wrap items-center gap-2 overflow-hidden rounded-xl border p-2 ${isDark ? "border-white/10 bg-[var(--bg-secondary)]" : "border-slate-200 bg-white"}`}>
          {TABS.map((tab) => (
            <button
              key={tab.key}
