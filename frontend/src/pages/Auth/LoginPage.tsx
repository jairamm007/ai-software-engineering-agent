    ...
    <div className={`flex min-h-screen transition-colors duration-300 ${
      ...
      <div className="hidden w-1/2 items-center justify-center lg:flex">
        <div className="max-w-md text-center">
          ...
          <h1 className={`text-3xl font-bold ${isDark ? "text-white" : "text-slate-900"}`}>Welcome back</h1>
          <p className={`mt-3 text-lg ${isDark ? "text-slate-400" : "text-slate-500"}`}>
            Sign in to access your AI-powered engineering workspace
          </p>
          <div className="mt-8 space-y-3">
            {["AI-powered code analysis", "Smart repository indexing", "Security vulnerability detection"].map((f) => (
      ...
      <div className="flex w-full items-center justify-center px-6 lg:w-1/2">
        ...
        >
          ...
          <form onSubmit={(e) => void handleSubmit(e)} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className={`text-xs ${isDark ? "text-slate-400" : "text-slate-500"}`}>Remember me</span>
              </label>
              <Link to="/forgot-password" className="text-xs font-medium text-violet-500 hover:text-violet-400">
                Forgot password?
              </Link>
            </div>
          ...
          <p className={`text-center text-sm ${isDark ? "text-slate-400" : "text-slate-500"}`}>
            ...
            <Link to="/register" className="font-medium text-violet-500 hover:text-violet-400">Sign up</Link>
          </p>
        </motion.div>
      </div>
    </div>
