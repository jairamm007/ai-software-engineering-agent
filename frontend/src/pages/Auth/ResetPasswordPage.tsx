...
const features = [
  ...
  { icon: RefreshCw, text: "Instant account recovery" },
  { icon: Clock, text: "Session restored automatically" },
];
  ...
  const renderLeftPanel = ({ heading, subheading }: { heading: string; subheading: string }) => (
    <div className="relative hidden w-1/2 items-center justify-center overflow-hidden lg:flex">
      ...
      <div className="relative z-10 max-w-md px-8 text-center">
        ...
        >
          <span className="accent-gradient-text">{heading}</span>
        </motion.h1>
...
<div className={`flex min-h-screen overflow-x-hidden transition-colors duration-300 ${
        ...
        <div className="relative flex w-full items-center justify-center px-6 py-6 lg:py-8 lg:w-1/2">
          ...
          <div className="relative">
            ...
            className={`relative z-10 mx-auto w-full max-w-2xl space-y-5 overflow-hidden rounded-3xl border p-6 text-center sm:p-8 backdrop-blur-xl ${
              isDark
