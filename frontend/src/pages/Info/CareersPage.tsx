...
import { Heart, GitPullRequest, Code2, MessageCircle, Shield, ExternalLink, ListChecks } from "lucide-react";
            ...
            <ul className="space-y-2.5">
              {goodFirstIssues.map((issue, i) => (
                <motion.li
                  ...
                  className={cn("flex items-center gap-3 rounded-xl border px-4 py-3 text-sm", isDark ? "border-white/[0.06] bg-white/[0.03] text-slate-300" : "border-slate-200/70 bg-white/50 text-slate-600")}
                >
                  <motion.span
